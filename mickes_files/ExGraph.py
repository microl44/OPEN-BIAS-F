...
def GraphDijkstra():
	...
	axs[0,0].bar(plotX, MT, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[0,0].set_title("Mapped Dijkstra time (s)")
	axs[0,0].set_ylim(ylimT)
	axs[1,0].bar(plotX, MD, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[1,0].set_title("Mapped Dijkstra distance (m)")
	axs[1,0].set_ylim(ylimD)
	axs[0,1].bar(plotX, UT, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[0,1].set_title("Unmapped Dijkstra time (s)")
	axs[0,1].set_ylim(ylimT)
	axs[1,1].bar(plotX, UD, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[1,1].set_title("Unmapped Dijkstra distance (m)")
...
def GraphAStar():
	...
	fig.suptitle('Results')
	axs[0,0].bar(plotX, MT, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[0,0].set_title("Mapped A-STAR time (s)")
	axs[0,0].set_ylim(ylimT)
	axs[1,0].bar(plotX, MD, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[1,0].set_title("Mapped A-STAR distance (m)")
	axs[1,0].set_ylim(ylimD)
	axs[0,1].bar(plotX, UT, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[0,1].set_title("Unmapped A-STAR time (s)")
	axs[0,1].set_ylim(ylimT)
	axs[1,1].bar(plotX, UD, width=0.3, color=['red', 'green', 'blue', 'black'])
	axs[1,1].set_title("Unmapped A-STAR distance (m)")
	axs[1,1].set_ylim(ylimD)
